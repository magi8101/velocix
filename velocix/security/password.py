...
class PasswordStrengthValidator:
    ...
    def estimate_strength(
        self, password: str
    ) -> Literal["weak", "medium", "strong", "very_strong"]:
...
class PasswordHasher:
    ...
    def verify_password(
        self, password: str, password_hash: str, constant_time: bool = True
    ) -> bool:
...
class Argon2Hasher:
    ...
    def __init__(self, time_cost: int = 2, memory_cost: int = 65536, parallelism: int = 4) -> None:
        try:
            ...
            raise ImportError(
                "argon2-cffi is required for Argon2Hasher. Install with: pip install argon2-cffi"
            ) from exc
