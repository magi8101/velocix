...
class Response:
    ...
    def __init__(
        ...
        self.background: BackgroundTask | None = background
        self.body: bytes | memoryview = self.render(content)
...
class EventStreamResponse(StreamingResponse):
    ...
    async def _format_events(
        self, content: AsyncIterator[dict[str, Any]] | Callable[[], AsyncIterator[dict[str, Any]]]
    ) -> AsyncIterator[bytes]:
...
class JSONLinesResponse(StreamingResponse):
    ...
    async def _format_jsonl(
        self, content: AsyncIterator[Any] | Callable[[], AsyncIterator[Any]]
    ) -> AsyncIterator[bytes]:
...
class RedirectResponse(Response):
    ...
    def __init__(
        ...
        super().__init__(
            content=b"", status_code=status_code, headers=headers, media_type="text/plain"
        )
