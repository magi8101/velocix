...
class UploadFile:
    ...
    __slots__ = ("filename", "content_type", "file_path", "_file", "_closed")

    def __init__(self, filename: str, content_type: str = "application/octet-stream") -> None:
...
class MultipartForm:
    ...
    def __init__(self, max_size: int = 10 * 1024 * 1024, max_fields: int = 1000) -> None:
    ...
    async def parse(self, receive: Any, content_type: str) -> dict[str, Any]:
        ...
        for i, part in enumerate(parsed):
            ...
            if filename is not None:
                ...
                upload = UploadFile(
                    filename.decode("latin-1"), file_type or "application/octet-stream"
                )
